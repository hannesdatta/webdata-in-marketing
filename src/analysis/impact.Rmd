...
cites <- cites[!grepl('Book review|correction|editorial|film|letter|meeting|abstract|news|reprint|retraction|software|(review,book chapter)|(review,early access)|(retracted)', doctype,ignore.case=T)]
table(cites$doctype)
