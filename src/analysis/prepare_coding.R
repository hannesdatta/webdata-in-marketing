...
# Merge w/ our own coding
  ...
  drive_download(as_id('1TU1q_jXhUXsVcyxCr9fYGD9mK6j3he5f'), path = '../../data/coding/coding.xlsx', overwrite=T)
...
# Citations via WOS extended
  cites = fread('../../gen/analysis/temp/wos_citations.csv')
...
# Load journal coding
  ...
  fwrite(coding, '../../gen/analysis/temp/coding.csv')
  
  save(coding, cites_summary, cites_yearly, papers, bib_analysis, file= '../../gen/analysis/temp/citation_database.RData')
